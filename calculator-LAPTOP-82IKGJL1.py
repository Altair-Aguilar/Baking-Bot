...
#asks user if they want to add more ingredients
#more = True
#while more:
	#answer = input("Would you like to add another ingredient? yes or no")
	#if answer.lower() == "yes" or answer.lower() =="y":
		#percentage = input("What percentage do you want this ingredient to be?")
